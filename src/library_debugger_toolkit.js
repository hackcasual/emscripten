      ...
      switch (this.derives[i][TAG_IDX]) {
        ...
        case DW_TAG_inheritance: {
          ...
          if (this.derives[i][OFFSET_IDX] % 8 !== 0) {
            console.log("STWD:  Weird offset ", this.offset, name_vec, this.type_id);
          }
        } break;
        case DW_TAG_member: {
          this.isMember = true;
          ...
          if (this.derives[i][SIZE_IDX] % 8 !== 0) {
            console.log("STWD:  Weird size ", this.offset, name_vec, this.derives[i][SIZE_IDX], this.type_id);
          }
          if (this.derives[i][OFFSET_IDX] % 8 !== 0) {
            console.log("STWD:  Weird offset ", this.offset, name_vec, this.derives[i][SIZE_IDX], this.derives[i], this.type_id);
          }
        } break;
        case DW_TAG_typedef: {
